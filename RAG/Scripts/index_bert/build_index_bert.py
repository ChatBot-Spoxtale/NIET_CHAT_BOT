...
#         why = course.get("why_choose", [])
#         url = course.get("source_url", "")
#         placement = course.get("placements", {})
...
#                     chunks.append(f"Why choose {name}: {w}".strip())

#         elif isinstance(why, str) and why.strip():
#             chunks.append(f"Why choose {name}: {why}".strip())

#         chunks.append(
#             f"""
# {name} is also known as:
# {degree} {" ".join(branches)}
# btech {" ".join(b.lower() for b in branches)}
#             """.strip()
#         )

#     facilities = courses.get("facilities", {})

#     if isinstance(facilities, dict):
#         for category, fac_list in facilities.items():
...
#             "text": chunk
#         })
#         facility_chunks = [c for c in chunks if c.startswith("Facility:")]
#         course_chunks = [c for c in chunks if c.startswith("Course Name:")]

#         print("Course chunks:", len(course_chunks))
#         print("Facility chunks:", len(facility_chunks))
